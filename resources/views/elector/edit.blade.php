    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <form class="form" action="{{ route('elector.update',$elector->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{ old('telepon',$elector->telepon) }}"
                                            >
                                            @error('telepon')
                                             <span class="error invalid-feedback">
                                                {{ $message }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status_pemilih" class="form-control @error('status_pemilih') is-invalid @enderror">
                                                <option value="1" {{ old('status_pemilih',$elector->status_pemilih) == '1' ? 'selected' : '' }}>Terdaftar di KPU</option>
                                                <option value="0" {{ old('status_pemilih',$elector->status_pemilih) == '0' ? 'selected' : '' }}>Belum Terdaftar di KPU</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="gender_laki" value="Laki-laki" {{ old('jenis_kelamin',$elector->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }} required>
                                                <label class="form-check-label" for="gender_laki">
                                                    Laki-laki
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="gender_perempuan" value="Perempuan" {{ old('jenis_kelamin',$elector->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }} required>
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="distrik" class="form-control select2" style="width: 100%;" name="distrik_id">
                                                ...
                                                <option value="{{ $distrik->id }}" {{ old('distrik_id', $elector->distrik_id) == $distrik->id ? 'selected' : '' }}>
                                                    {{ $distrik->nama }}
                                                </option>
                                            @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="alamat"   @error('alamat') is-invalid @enderror placeholder="Alamat Pemilih ...">{{ old('alamat',$elector->alamat) }}</textarea>
                                           @error('alamat')
                                         <span class="error invalid-feedback">
                                         {{ $message }}
                                          </span>
...
<script>
 $(document).ready(function() {
    var selectedDesaId = {{ $elector->desa_id ?? 'null' }};
    var selectedTpsId = {{ $elector->tps_id ?? 'null' }};
