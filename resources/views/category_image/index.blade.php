...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Kategori Tebak Gambar') }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                                ...
                                @foreach($category as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('category_image.destroy', $data->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <div class="modal fade" id="modal-lg{{$data->id}}">
                                        <div class="modal-dialog modal-lg">
                                          <div class="modal-content">
                                            ...
                                            <form action="{{ route('category_image.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
      ...
      <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="{{ route('category_image.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
                <div class="form-group">
                    <label>Nama</label>
